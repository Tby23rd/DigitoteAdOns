...
const Testimonials: React.FC = () => {
  ...
  return (
    <div className="container mx-auto lg:w-2/3">
      <motion.div
        className="flex flex-col lg:flex-row items-center bg-primary-blue rounded-lg px-8 pt-8 mx-4"
      ...
      >
        ...
        <div className="flex justify-end mt-4">
            <button
              onClick={openModal}
              className="bg-primary-pink hover:bg-primary-cyan-75 text-white px-4 py-2 rounded-full text-sm font-medium"
            >
              Book a Demo!
            </button>
